Writing Environment Pi update 0.5.2
===================================
...
Open Terminal in the local folder and run:
  ...
  tar -xzf writing-environment-pi-source-update-0.5.2-20260729.tar.gz
  cd writing-environment-pi-source-update-0.5.2-20260729
