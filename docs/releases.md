...
7. Confirm the GitHub Release contains `latest.json`, the Linux amd64 `.deb`, AppImage, and RPM artifacts plus updater signatures, the signed macOS artifact, the Raspberry Pi manual archive, and the four appliance/repository packages.
